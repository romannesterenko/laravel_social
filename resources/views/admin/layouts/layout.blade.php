                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.communities.index')}}">Список</a></li>
                            <li><a href="{{route('admin.communities.categories.index')}}">Категории</a></li>
                            <li><a href="email-read.html">Подписчики</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('admin.comments.index')}}">Список</a></li>
                            <li><a href="email-read.html">Категории</a></li>
                            <li><a href="email-read.html">Подписчики</a></li>
                        </ul>
                    </li>
