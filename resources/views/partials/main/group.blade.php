...
@section('layout')
    @php
        /** @var \App\Models\Community $community */
    @endphp
    <main>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 order-3">
                        <aside class="widget-area">
                            <!-- widget single item start -->
                            <div class="card widget-item">
                                <h4 class="widget-title"><a href="{{route('groups.subscribers', $community)}}" style="color: #333333">Osoby zapisane <span style="color: #666666">({{$community->subscribers->count()}})</span></a></h4>
                                <div class="widget-body">
                                    <ul class="like-page-list-wrapper">
                                        @foreach($community->fiveSubscribers as $subscriber)
                                            <li class="unorder-list">
                                            <!-- profile picture end -->
                                            <div class="profile-thumb">
                                                <a href="#">
                                            ...
                                            <div class="unorder-list-info">
                                                <h3 class="list-title"><a href="#">{{$subscriber->user->full_name}}</a></h3>
                                            </div>
                                        </li>
                                        @endforeach
                                    </ul>
